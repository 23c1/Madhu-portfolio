...
const certifications = [
  {
    ...
    certificateUrl:
      'https://drive.google.com/file/d/1gyy0jVrRrDy4LtkhWyPUH1sMzVvt2LfK/view',
  },
  {
    title: 'Programming in C++',
    issuer: 'Cisco',
    ...
    certificateUrl:
      'https://drive.google.com/file/d/1JPJFWNzo3omO-BJ7UEmp0NMDoeqGAFoL/view',
  },
  {
    ...
    certificateUrl:
      'https://drive.google.com/file/d/19_Y57XHpdgNeD-KOSvi_DiOQH2gvMfgb/view',
  },
  {
      ...
      <div className="container mx-auto max-w-4xl">
        ...
        <div ref={ref} className="space-y-4">
          {certifications.map((cert, index) => {
            ...
            const isClickable = Boolean(cert.certificateUrl);

            const CardContent = (
              <div
                className={`glass-card group rounded-xl p-6 flex items-center gap-6 transition-all duration-300 ${
                  isVisible
              ...
              >
                <div
                  className={`w-14 h-14 shrink-0 rounded-xl bg-gradient-to-br ${cert.color} p-3`}
                >
            ...
            // 🔒 If certificate exists → wrap in <a>
            if (isClickable) {
              return (
                <a
                  key={cert.title}
